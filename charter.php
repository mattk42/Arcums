...
$link = mysql_connect("localhost", "arcums", "arcums123") or die("Could not connect to database");
	$query = "SELECT dj,artist, song, label, datetime as date FROM arcums.playlist where date between '$csdate' and '$csdate  24:59:59' UNION SELECT songrights as dj,artist, title as song, label, date_played as date from automation.historylist where automation.historylist.date_played between '$csdate' and '$cedate' order by date DESC";
