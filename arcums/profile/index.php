...
';
        ...
        ?>
          <select name="hideaccount" class="register_box" />
            <option value="0" <?php if($user_info['hideaccount'] == "0") { echo "selected"; } ?>>No</option>
            <option value="1" <?php if($user_info['hideaccount'] == "1") { echo "selected"; } ?>>Yes</option>
                      </select>
       <?php
        echo'
</td>
...
';
        ...
        ?>
          <select name="showday" class="register_box" />
            <<option <?php if($user_info['showday'] == "Sunday") { echo "selected"; } ?>>Sunday</option>
            <option <?php if($user_info['showday'] == "Monday") { echo "selected"; } ?>>Monday</option>
            <option <?php if($user_info['showday'] == "Tuesday") { echo "selected"; } ?>>Tuesday</option>
           <option <?php if($user_info['showday'] == "Wednesday") { echo "selected"; } ?>>Wednesday</option>
             <option <?php if($user_info['showday'] == "Thursday") { echo "selected"; } ?>>Thursday</option>
          <option <?php if($user_info['showday'] == "Friday") { echo "selected"; } ?>>Friday</option>
          <option <?php if($user_info['showday'] == "Saturday") { echo "selected"; } ?>>Saturday</option>
          </select>
      
          <select name="showtime" class="register_box" />
            <option <?php if($user_info['showtime'] == "12AM-3AM") { echo "selected"; } ?>>12AM-3AM</option>
            <option <?php if($user_info['showtime'] == "3AM-6AM") { echo "selected"; } ?>>3AM-6AM</option>
            <option <?php if($user_info['showtime'] == "6AM-9AM") { echo "selected"; } ?>>6AM-9AM</option>
            <option <?php if($user_info['showtime'] == "9AM-Noon") { echo "selected"; } ?>>9AM-Noon</option>
            <option <?php if($user_info['showtime'] == "Noon-3PM") { echo "selected"; } ?>>Noon-3PM</option>
            <option <?php if($user_info['showtime'] == "3PM-6PM") { echo "selected"; } ?>>3PM-6PM</option>
            <option <?php if($user_info['showtime'] == "6PM-9PM") { echo "selected"; } ?>>6PM-9PM</option>
            <option <?php if($user_info['showtime'] == "9PM-12AM") { echo "selected"; } ?>>9PM-12AM</option>
          </select>
       <?php
        echo'
</td>
...
';
        ...
        ?>hide?
          <select name="hideemail" class="register_box" />
           <option  value="0" <?php if($user_info['hideemail'] == "0") { echo "selected"; } ?>>No</option>
           <option value="1" <?php if($user_info['hideemail'] == "1") { echo "selected"; } ?>>Yes</option>
                      </select>
       <?php
        echo'
</td>
